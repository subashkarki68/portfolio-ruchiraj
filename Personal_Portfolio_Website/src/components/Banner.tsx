...
const Banner = () => {
  ...
  return (
    <div className="relative w-full h-[100svh] flex items-center justify-center">
      ...
      {/* Text and Button */}
      <div className="absolute mt-10 left-10 top-1/2 transform -translate-y-1/2 text-white">
        <div
          id="typeWriter"
        ...
        <p className="mt-20 lg:w-[600px] md:w-[70%]" id="para">
        ...
        <a href={resumePDF} download="Ruchi_Raj_CV.pdf">
          <Button
            id="downloadCV"
            className="text-md p-5 bg-[#1ad1da] text-black mt-10"
          >
            Download CV
          </Button>
        </a>
